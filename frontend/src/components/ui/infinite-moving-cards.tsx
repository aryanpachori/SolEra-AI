  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="relative w-[350px] max-w-full shrink-0 rounded-2xl border border-b-0 border-gray-700 bg-[linear-gradient(180deg,#1f2937,#111827)] px-8 py-6 md:w-[450px]"
            key={item.name}
          >
            <blockquote>
              <div
